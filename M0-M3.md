...
- [ ] Add wgpu dependency to Cargo.toml
- [ ] Create `Renderer` struct to own wgpu state
- [ ] Initialize instance, adapter, device, queue
- [ ] Create surface from winit window
- [ ] Configure surface with appropriate present mode and format
- [ ] Handle surface reconfiguration on resize
...
- [ ] Implement frame acquisition from surface
- [ ] Create render pass with clear color
- [ ] Submit command buffer to queue
- [ ] Present frame to swapchain
- [ ] Handle `WindowEvent::RedrawRequested`
- [ ] Handle `WindowEvent::Resized` to reconfigure surface
...
- [ ] Store scale factor in Application/Renderer state
- [ ] Handle `WindowEvent::ScaleFactorChanged`
- [ ] Configure surface size with physical pixels
- [ ] Expose logical size to layout system
- [ ] Test on 1x, 2x, and fractional DPI displays
